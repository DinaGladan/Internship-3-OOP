...
namespace Airport.Classes
{
    public class Passenger : BaseEntity
    {
        ...
        public Passenger(string name, string surname, DateOnly birthdate, string email, string password) : base(){
        ...
        public void UpdatePassenger(string name, string surname, DateOnly birthdate, string email, string password) { 
            Name = name;
            Surname = surname;
            Birthdate = birthdate;
            Email = email;
